// This is to generate a <link rel="modulepreload" href='https://themer.sanity.build/api/hues?primary=68b3f0'> to the <head>
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          rel="modulepreload"
          href={'https://themer.sanity.build/api/hues?primary=68b3f0'}
        />
